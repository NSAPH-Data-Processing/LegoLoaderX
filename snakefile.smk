    ...
    with open(f"conf/var_group/{vg}.yaml", "r") as f:
        ...
        if var_map[vg]["temporal_res"] == "daily":
            ...
            for y,m,d in var_map[vg]["date_range"]:
                output_file_lst += expand("data/covars/{var_group}/{var}/{var}__{year}{month:02d}{day:02d}.parquet",
                                            var_group=vg,
            ...
            output_file_lst += expand("data/covars/{var_group}/{var}/{var}__{year}{month:02d}.parquet",
                            var_group=vg,
                            var=[v for v in vg_cfg["vars"]],
            ...
            output_file_lst += expand("data/covars/{var_group}/{var}/{var}__{year}.parquet",
                var_group=vg,
                var=[v for v in vg_cfg["vars"]],
...
rule preprocess:
    output:
        "data/covars/{var_group}/{var}/{var}__{timestring}.parquet"
    params:
